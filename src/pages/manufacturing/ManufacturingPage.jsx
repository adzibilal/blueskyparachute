    ...
    <div className="min-h-screen">
      <SEO
        ...
        structuredData={{
          ...
          description:
            "Blue Sky Parachutes manufacturing facilities with cutting-edge technology and international standards",
          url: "https://blueskyparachute.com/manufacturing",
          about: {
            "@type": "ManufacturingProcess",
            name: "Parachute Manufacturing Process",
            description:
              "Parachute manufacturing process with cutting-edge technology and international standards",
          },
        }}
      />
      {/* Hero Section */}
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-secondary-300 mb-5">
              ...
              customers to the same strict standards as those for the Indonesian
              Military. All of our products are subject to the Indonesian
              Department of Commerce Export Administration Regulations under the
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-secondary-300 max-w-4xl mx-auto">
              ...
              deceleration parachutes we manufacture are procured by the
              Indonesian Air Force and many other countries. We can also
              manufacture custom military parachutes as requested.
            </p>
          </div>
        </div>
      </section>
