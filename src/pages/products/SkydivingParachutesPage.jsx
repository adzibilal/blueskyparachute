      ...
      <section className="py-20 bg-primary-100">
        <div className="container">
          ...
          >
            {/* Product Image */}
            <motion.div 
              className="bg-primary-700 p-8 rounded-2xl shadow-lg border border-primary-700"
            ...
            <div className="bg-primary-700 p-8 md:p-12 rounded-2xl shadow-lg border border-primary-700">
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2">
                  <li className="text-secondary-200 relative pl-6 before:content-['•'] before:absolute before:left-0 before:text-secondary-400 before:font-bold">Full control for canopy pilot</li>
                  <li className="text-secondary-200 relative pl-6 before:content-['•'] before:absolute before:left-0 before:text-secondary-400 before:font-bold">Structured wing design</li>
                  <li className="text-secondary-200 relative pl-6 before:content-['•'] before:absolute before:left-0 before:text-secondary-400 before:font-bold">Responsive steering lines</li>
                  <li className="text-secondary-200 relative pl-6 before:content-['•'] before:absolute before:left-0 before:text-secondary-400 before:font-bold">High safety for sports</li>
                  <li className="text-secondary-200 relative pl-6 before:content-['•'] before:absolute before:left-0 before:text-secondary-400 before:font-bold">High-quality materials</li>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-secondary-200">High-quality nylon with waterproof coating</p>
              </motion.div>
              <motion.div 
                className="text-center p-6 bg-primary-600 rounded-lg border border-primary-500 transition-all duration-300 hover:bg-primary-500 hover:-translate-y-1 hover:shadow-lg"
                whileHover={{ scale: 1.02 }}
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-secondary-200">Various sizes available according to needs</p>
              </motion.div>
              <motion.div 
                className="text-center p-6 bg-primary-600 rounded-lg border border-primary-500 transition-all duration-300 hover:bg-primary-500 hover:-translate-y-1 hover:shadow-lg"
                whileHover={{ scale: 1.02 }}
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-secondary-200">Control system with responsive steering lines</p>
              </motion.div>
              <motion.div 
                className="text-center p-6 bg-primary-600 rounded-lg border border-primary-500 transition-all duration-300 hover:bg-primary-500 hover:-translate-y-1 hover:shadow-lg"
                whileHover={{ scale: 1.02 }}
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-secondary-200">International safety standards for sports</p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="text-secondary-300 text-lg leading-relaxed relative pl-8 before:content-['✓'] before:absolute before:left-0 before:text-secondary-400 before:font-bold before:text-xl">Recreational skydiving</li>
                <li className="text-secondary-300 text-lg leading-relaxed relative pl-8 before:content-['✓'] before:absolute before:left-0 before:text-secondary-400 before:font-bold before:text-xl">Skydiving competitions</li>
                <li className="text-secondary-300 text-lg leading-relaxed relative pl-8 before:content-['✓'] before:absolute before:left-0 before:text-secondary-400 before:font-bold before:text-xl">Freefall training</li>
                <li className="text-secondary-300 text-lg leading-relaxed relative pl-8 before:content-['✓'] before:absolute before:left-0 before:text-secondary-400 before:font-bold before:text-xl">Air sports</li>
                <li className="text-secondary-300 text-lg leading-relaxed relative pl-8 before:content-['✓'] before:absolute before:left-0 before:text-secondary-400 before:font-bold before:text-xl">Outdoor recreational activities</li>
              </ul>
            </div>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-secondary-300">Structured wing design that allows full control and precise maneuvering.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Quality Materials</h3>
                  <p className="text-secondary-300">Uses the finest materials that are durable and safe for intensive use.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Responsive Control</h3>
                  <p className="text-secondary-300">Responsive control system allows pilots to perform maneuvers with ease.</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Safety Standards</h3>
                  <p className="text-secondary-300">Meets international safety standards for freefall sports.</p>
                </div>
              </div>
            </div>
          </div>
